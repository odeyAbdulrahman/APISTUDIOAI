...
const footerColumns = [
  ...
  {
    title: "الموارد",
    links: ["المدونة", "مركز المساعدة", "دليل الاستخدام", "توثيق واجهة البرمجة"],
  },
  {
    title: "القطاعات",
        ...
        <div className="footer-main">
          ...
          <section className="footer-brand" aria-label="عن Skilltax">
            ...
            <div className="footer-social" aria-label="حسابات التواصل الاجتماعي">
              <a href="#facebook" aria-label="فيسبوك">f</a>
              <a href="#x" aria-label="X">𝕏</a>
              <a href="#linkedin" aria-label="لينكدإن">in</a>
              <a href="#instagram" aria-label="إنستغرام">◎</a>
              <a href="#youtube" aria-label="يوتيوب">▶</a>
            </div>
          </section>
        </div>
